...
public class calculadora {
	...
	/**
	 * 
	 * @param This program the user chooses an operation for two numbers such as addition, 
	 *        subtraction, multiplication, divide, root, residue and power
	 * @return
	 */
	
	 public static int option,operator,number1,number2,base, exponent, result;
	    ...
	    private static void power(int base, int exponent) throws IOException {
	        ...
	        bw.write("The power of base " + base + " and exponent " + exponent + " is " + result2 + "\n");
	        bw.flush(); 
	    }
	    ...
	    private static void residue(int number1, int number2) throws IOException {
	        ...
	        bw.write("The residue of " + number1 + " residue " + number2 + " is " + result2 + "\n");
	        bw.flush(); 
	    }
	    private static void division(int number1, int number2) throws IOException {
	        ...
	        bw.write("The division of " + number1 + " divided " + number2 + " is " + result2 + "\n");
	        bw.flush(); 
	    }
	    private static void multiplication(int number1, int number2) throws IOException {
	       
	    	result=number1*number2;
	        
			BufferedWriter bw = new BufferedWriter ( new OutputStreamWriter ( System.out ));
	        
	        bw.write("The multiplication of " + number1 + " multiplied " + number2 + " is " +  	result + "\n");
	        bw.flush();
	    }
	    private static void substraction(int number1, int number2) throws IOException {
	    	
			BufferedWriter bw = new BufferedWriter ( new OutputStreamWriter ( System.out ));
			
	        result=number1-number2;
	        bw.write("The substraction of " + number1 + " less " + number2 + " is " + result + "\n");
	        bw.flush();
